...
class TestJavaRuntimeValidator(TestCase):
    ...
    def test_java8_runtime_accepts_java_8_executable(self):
    ...
    def test_java8_runtime_rejects_other_versions(self, version):
    ...
    # TODO: not actually sure if this should be expected behavior if the runtime is just 'java' or if 'java' == 'java8'
